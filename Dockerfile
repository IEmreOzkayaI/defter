...
# error_log stdout + warn: startup/worker [notice] spam'ini keser; uyarı/hata kalır.
RUN sed -i 's|error_log  /var/log/nginx/error.log notice;|error_log /dev/stdout warn;|' /etc/nginx/nginx.conf \
