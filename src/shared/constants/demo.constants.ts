...
export const ONBOARD_STEPS = [
  {
    ...
    desc: 'Size en uygun şablonu seçin; dil ve akış otomatik yerleşsin.',
    color: '#f0ece4',
    icon: '◉',
  },
  {
    title: 'Menünüzü gruplayın',
    desc: 'Kategori başlıklarını oluşturun, menü düzenini hızlıca kurun.',
    color: '#e4ecf0',
    icon: '◱',
  },
  {
    title: 'Teklifinizi oluşturun',
    desc: 'Ürün ve hizmetleri fiyat/süre ile tanımlayın.',
    color: '#e4f0e8',
    icon: '▤',
  },
  {
    title: 'Kasaları bağlayın',
    desc: 'POS cihazlarını bağlayın, ödeme noktalarını hazır edin.',
    color: '#ece4f0',
    icon: '⬡',
  },
  {
    title: 'Adisyonu açın',
    desc: 'Masa/kabin/cihaz kaydını açın, kalemleri ekleyin.',
    color: '#e8ecf4',
    icon: '◫',
  },
  {
    title: 'Tahsilatı kapatın',
    desc: 'Ödemeyi alın, işlemi tek adımda kapatın.',
    color: '#f0e4ec',
    icon: '◎',
  },
  {
    title: 'Performansı görün',
    desc: 'Ciro ve yoğunluğu raporda anlık takip edin.',
    color: '#ecf0e4',
    icon: '◩',
  },
];
